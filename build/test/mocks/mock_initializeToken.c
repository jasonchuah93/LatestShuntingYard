...
Tokenizer* initTokenizer(char* expressions)
{
  ...
  if (Mock.initTokenizer_CallbackFunctionPointer != NULL)
  {
    return Mock.initTokenizer_CallbackFunctionPointer(expressions, Mock.initTokenizer_CallbackCalls++);
  }
...
void CMockExpectParameters_initTokenizer(CMOCK_initTokenizer_CALL_INSTANCE* cmock_call_instance, char* expressions)
{
  cmock_call_instance->Expected_expressions = expressions;
}
