...
extern void test_should_evaluate_left_left_left_parenthesis_16_right_right_right_parenthesis(void);
...
int main(void)
{
  ...
  RUN_TEST(test_should_evaluate_left_left_left_parenthesis_16_right_right_right_parenthesis, 208);
