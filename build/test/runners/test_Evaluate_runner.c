...
int main(void)
{
  ...
  UnityBegin();
  RUN_TEST(test_shunting_yard_should_return_0_if_the_expression_is_null, 36);
  RUN_TEST(test_should_return_3_for_1_plus_2, 61);
  RUN_TEST(test_should_return_6_for_60_divide_10, 110);
  RUN_TEST(test_evaluate_2_MULTIPLY_3_PLUS_4, 167);
  RUN_TEST(test_evaluate_2_PLUS_3_MULTIPLY_4_PLUS_5_MULTIPLY_6, 253);
  RUN_TEST(test_evaluate_2_MULTIPLY_3_PLUS_4_MULTIPLY_5_PLUS_6, 396);
  RUN_TEST(test_2_OR_3_PLUS_4_MULTIPLY_5_MINUS_6_MINUS_10, 532);
  RUN_TEST(test_should_evaluate_43_HASHTAG_42_and_throw_error_invalid_operator, 697);
  RUN_TEST(test_should_evaluate_left_parenthesis_2_right_parenthesis, 733);
  RUN_TEST(test_should_evaluate_left_parenthesis_22_right_parenthesis, 792);
  RUN_TEST(test_left_bracket_2_plus_3_right_bracket, 851);
  RUN_TEST(test_left_bracket_20_multiply_3_subtract_50_right_bracket, 923);
  RUN_TEST(test_logic_not_12_SHOULD_RETURN_0, 1020);
  RUN_TEST(test_NEGATIVE_2_SHOULD_RETURN_NEGATIVE_2, 1073);
